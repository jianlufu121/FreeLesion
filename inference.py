...
from ldm.data.idrid import idrid_dict
...
#        pdb.set_trace()
    ...
    if opt.dataset == "idrid":
        val_dataset = idridVal(data_root=opt.data_root, txt_file=opt.txt_file)
